...
// Light theme colors
val MainColor = Color(0xFFDCF2F1)    // Light mint/cyan
val RegColor = Color(0xFF7FC7D9)     // Light blue
val TextColor = Color(0xFF365486)    // Dark blue
val TextColor2 = Color(0xFF0F1035)   // Very dark blue
